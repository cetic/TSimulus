...
/**
  ...
  * true values if the values of A is greater than the values of B, and
  * false otherwise.
  *
  ...
  *
  */
class GreaterThanTimeSeries(a: TimeSeries[Double], b: TimeSeries[Double], strict: Boolean = false)
