...
/**
  * A generator for [[be.cetic.tsimulus.timeseries.primary.dt.HourTimeSeries]].
  *
  * @param name The generator name.
  */
class HourGenerator(name: Option[String]) extends Generator[Int](name, "hour")
{
   override def timeseries(generators: String => Generator[Any]) = HourTimeSeries()
