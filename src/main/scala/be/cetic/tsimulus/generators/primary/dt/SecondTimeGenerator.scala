...
/**
  * A generator for [[be.cetic.tsimulus.timeseries.primary.dt.SecondTimeSeries]].
  *
  * @param name The generator name.
  */
class SecondTimeGenerator(name: Option[String]) extends Generator[Int](name, "second")
{
   ...
   override def equals(o: Any) = o match {
      case that: SecondTimeGenerator => that.name == this.name
      case _ => false
   }
