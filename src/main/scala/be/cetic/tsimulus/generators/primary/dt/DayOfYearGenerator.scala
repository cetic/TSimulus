...
import be.cetic.tsimulus.timeseries.primary.dt.DayOfYearTimeSeries
import spray.json.{DefaultJsonProtocol, JsObject, JsString, JsValue, _}

/**
  * A generator for [[be.cetic.tsimulus.timeseries.primary.dt.DayOfYearTimeSeries]].
  *
  * @param name The generator name.
  */
class DayOfYearGenerator(name: Option[String]) extends Generator[Int](name, "doy")
{
   override def timeseries(generators: String => Generator[Any]) = DayOfYearTimeSeries()
