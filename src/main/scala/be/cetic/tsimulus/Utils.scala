...
import be.cetic.tsimulus.config.{ARMAModel, Configuration}
import be.cetic.tsimulus.generators.primary.ARMAGenerator
import be.cetic.tsimulus.timeseries._
import be.cetic.tsimulus.timeseries.primary.{ARMA, MonthlyTimeSeries, RandomWalkTimeSeries, WeeklyTimeSeries}
