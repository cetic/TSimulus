...
The TSimulus library has been used to simulate various sensors from industrial partners in the context of these `many research projects <https://github.com/cetic/fadi#thanks>`_. It allowed to generate a suffisant amout of data to test all the FADI platform. It was usefull when there was a lack of data and in real time. TSimulus allowed to already work on the analysis part without having the real data from the partners. 
